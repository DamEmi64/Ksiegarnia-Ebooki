    ...
    return (
        <CategoriesContent>
            <Grid item container direction="column" rowGap={8} marginTop={2}>
                <EbooksSlider title="Nowości" ebooks={ebooks}/>
                <EbooksSlider title="Promocje" ebooks={ebooks}/>
                <EbooksSlider title="Bestsellery" ebooks={ebooks}/>
                <EbooksSlider title="Najlepsze książki 2022 roku" ebooks={ebooks}/>
            </Grid>
        </CategoriesContent>
    )
}
